...
-(void)setTabelView
{
    _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, -UpState, self.view.frame.size.width, self.view.frame.size.height+UpState) style:UITableViewStyleGrouped];
